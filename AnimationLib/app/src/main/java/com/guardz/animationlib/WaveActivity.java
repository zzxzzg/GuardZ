package com.guardz.animationlib;
...
import com.guard.animationlib.wave.WaveHelper;
import com.guard.animationlib.wave.WaveView;
...
public class WaveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CompoundButtonCompat.setButtonTintList(
            ...
            getResources().getColorStateList(R.color.wave_red));
        CompoundButtonCompat.setButtonTintList(
            (RadioButton) findViewById(R.id.colorGreen),
            getResources().getColorStateList(R.color.wave_green));
        CompoundButtonCompat.setButtonTintList(
            (RadioButton) findViewById(R.id.colorBlue),
            getResources().getColorStateList(R.color.wave_blue));
